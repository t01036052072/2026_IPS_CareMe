...
from app.pills import router as pill_router
from app.medications import router as pill_alarm_router
...
from app.healthcare import router as healthcare_router

# 공통 회원·문서 기능 및 데이터 구조 가져오기
from core.schemas import UserCreate, LoginRequest
from core.database import get_db
from core.models import UserTable
from core.routes.user import router as friend_user_router
from core.routes.document import router as friend_doc_router
from core.routes.mypage import router as friend_mypage_router
# 기존 import들 아래에 추가
...
app.include_router(chatbot_router, prefix="/chat", tags=["챗봇"])
